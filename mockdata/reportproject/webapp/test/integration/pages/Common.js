sap.ui.define([
	...
	return Opa5.extend("ux.reportproject.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ux/reportproject/localService/mockserver"], function (mockserver) {
